...
public class ClienteController {
	...
	public String formCliente(@Valid Cliente cliente, BindingResult result, Model model,
			SessionStatus status,@RequestParam("file") MultipartFile imagen) {
		if (result.hasErrors()) {
            return "crear/crearCliente";
        }
    ...
    public String eliminarCliente(@SessionAttribute(name= "cliente", required = false ) Cliente cliente,@PathVariable Long id, Model model) {
